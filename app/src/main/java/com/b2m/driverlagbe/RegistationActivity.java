...
public class RegistationActivity extends AppCompatActivity {
    private Button CreatedAccountButton;
    private EditText InputName,InputMail,InputPhone,InputPassword;
    private ProgressDialog loading;
    private TextView logInText,headerText;
    @Override
                    ...
                    Rootref.child("Users").child(phone).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    {
                                        Toast.makeText(RegistationActivity.this,"Congurtulation,Your registation is susscessfull",Toast.LENGTH_SHORT).show();
                                        loading.dismiss();
                                        Intent intent=new Intent(RegistationActivity.this,LoginActivity.class);
                                        startActivity(intent);
                                        finish();
