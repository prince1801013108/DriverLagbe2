...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView headerText,signUpText;
    @Override
    ...
    private void LoginAccessAccount(final String phone, final String password) {
        ...
        Rootref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else if (dataSnapshot.child(ParentDbName1).child(phone).exists()) {
                    Users userData = dataSnapshot.child(ParentDbName1).child(phone).getValue(Users.class);
                    if (userData.getPhone().equals(phone)) {
                        if (userData.getPassword().equals(password)) {
                            if (ParentDbName1.equals("Drivers")) {
                                Toast.makeText(LoginActivity.this, "Dear Driver,You are login successfully", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
    ...
    private void AllowAccess(final String phone, final String password) {
        ...
        Rootref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    Users userData=dataSnapshot.child("Drivers").child(phone).getValue(Users.class);
